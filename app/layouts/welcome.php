              ...
              <form>
                ...
                <div class="search-cities">
                  <div class="cities-list">
                    <a href="#" style="background-image:url('<?php echo STATICPATH ?>images/cities/thumbs/1.jpg')" data-city-id="1"><span>Boston</span></a>
                    <a href="#" style="background-image:url('<?php echo STATICPATH ?>images/cities/thumbs/2.jpg')" data-city-id="2"><span>Chicago</span></a>

                    <a href="#" style="background-image:url('<?php echo STATICPATH ?>images/cities/thumbs/4.jpg')" data-city-id="3"><span>New Orleans</span></a>
                    <a href="#" style="background-image:url('<?php echo STATICPATH ?>images/cities/thumbs/5.jpg')" data-city-id="4" class="go-more-cities"><span>More Cities</span></a>
                ...
                <div class="search-submit">
                  ...
                  <a href="<?php echo BASE_URL ?>/buscar/search" class="hero-search-icon"></a>
                </div>
              </form>
            </div>
            <!-- End Hero Search -->
      ...
      <div class="container-fluid front-categories vertical">
        ...
        <div class="row cat-itens">
          <div class="cat-item">
            ...
            <div  class="cat-image" style="background-image:url('<?php echo STATICPATH ?>images/categories/1.jpg')"></div>
          ...
          <div class="cat-item">
            <div class="cat-overlay"></div>
            <div class="cat-image" style="background-image:url('<?php echo STATICPATH ?>images/categories/2.jpg')"></div>
          ...
          <div class="cat-item">
            <div class="cat-overlay"></div>
            <div  class="cat-image" style="background-image:url('<?php echo STATICPATH ?>images/categories/3.jpg')"></div>
          ...
          <div class="cat-item">
            <div class="cat-overlay"></div>
            <div  class="cat-image" style="background-image:url('<?php echo STATICPATH ?>images/categories/6.jpg')"></div>
          ...
          <div class="cat-item">
            <div class="cat-overlay"></div>
            <div  class="cat-image" style="background-image:url('<?php echo STATICPATH ?>images/categories/10.jpg')"></div>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/trending//2.jpg" />
              </a>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/trending//3.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/trending//1.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/trending//4.jpg" />
              </a>
              <div class="listing-item-data">
                <a class="listing-item-address" href="#">
      ...
      <div class="container-fluid how color-bg">
        ...
        <div class="row how-items">
          ...
          <div class="col-sm-3">
            <div class="how-item">
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/icon-1.png" />
          ...
          <div class="col-sm-3">
            <div class="how-item">
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/icon-2.png" />
          ...
          <div class="col-sm-3">
            <div class="how-item">
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/icon-3.png" />
          ...
          <div class="col-sm-3">
            <div class="how-item">
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/icon-4.png" />
      ...
      <div class="container-fluid app">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="app-img">
              <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/mobile-cut-laguna-green.png"/>
            </div>
            <div class="app-links">
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/g-play.png" />
              </a>
              <a href="#">
                <img alt="" src="<?php echo STATICPATH ?>images/miscellaneous/app-st.png" />
              </a>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/blog/14.jpg" />
              </a>
              <div class="listing-item-data">
                <div class="listing-item-excerpt">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/blog/15.jpg" />
              </a>
              <div class="listing-item-data">
                <div class="listing-item-excerpt">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/blog/17.jpg" />
              </a>
              <div class="listing-item-data">
                <div class="listing-item-excerpt">
          ...
          <div class="col-sm-3">
            <div class="listing-item">
              ...
              <a href="#" class="listing-item-link">
                ...
                <img alt="" src="<?php echo STATICPATH ?>images/blog/16.jpg" />
              </a>
              <div class="listing-item-data">
                <div class="listing-item-excerpt">

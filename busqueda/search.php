        <?php include("../layouts/header_2.php"); ?>
        ...
        <link href="assets/plugins/css/jquery-ui.min.css" rel="stylesheet" type="text/css"> 
                ...
                <div class="theme-container container">
                    <div class="row">
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img alt="" src="assets/img/main/product/prod-5.jpg" class="img-responsive"> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img alt="" src="assets/img/main/product/prod-6.jpg" class="img-responsive"> </a>
                                                            </div>  
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img alt="" src="assets/img/main/product/prod-13.jpg" class="img-responsive">                                                      
                                                                </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#">
                                                                    <img alt="" src="assets/img/main/product/prod-5.jpg" class="img-responsive">                                                      
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <ul class="thumbnail-content hover-style1 list-items">
                                        ...
                                        <div class="tab-pane fade" id="tab-s1">
                                            <div class="recent-wrap">
                                                <div class="col-md-4 col-sm-5 recent-slide-img">
                                                    <div class="light-bg">                                                                                                                 
                                                        <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-thumb-2.jpg" alt=""/> </a>                                                                                                              
                                                    </div>
                                                </div>
                                            ...
                                            <div class="recent-wrap">
                                                <div class="col-md-4 col-sm-5 recent-slide-img">
                                                    <div class="light-bg">                                                                                                                 
                                                        <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-thumb-5.jpg" alt=""/> </a>                                                                                                              
                                                    </div>
                                                </div>
                                                <div class="col-md-8  col-sm-7 no-padding recent-slide-des">
                                            ...
                                            <div class="recent-wrap">
                                                <div class="col-md-4 col-sm-5 recent-slide-img">
                                                    <div class="light-bg">                                                                                                                 
                                                        <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-thumb-6.jpg" alt=""/> </a>                                                                                                              
                                                    </div>
                                                </div>
                                                <div class="col-md-8  col-sm-7 no-padding recent-slide-des">
                        ...
                        <aside class="col-md-9 col-sm-8  prod-categories cat-with-sidebar">
                            <div class="row">
                                <div class="col-md-6 col-sm-5 col-xs-3 show-result"> <h2 class="title"> show all 11 results </h2> </div>
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-1.jpg" alt=""/> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-6.jpg" alt=""/> </a>
                                                            </div>                                                       
                                                        </div>
                                                        <ul class="thumbnail-content hover-style1 list-items">
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-9.jpg" alt=""/> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-7.jpg" alt=""/>  </a>
                                                            </div>
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img class="img-responsive" src="assets/img/main/product/prod-10.jpg" alt=""/>                                                      
                                                                </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#">
                                                                    <img class="img-responsive" src="assets/img/main/product/prod-5.jpg" alt=""/>                                                      
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <ul class="thumbnail-content hover-style1 list-items">
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-5.jpg" alt=""/> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-6.jpg" alt=""/> </a>
                                                            </div>  
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img class="img-responsive" src="assets/img/main/product/prod-7.jpg" alt=""/>                                                      
                                                                </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#">
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-11.jpg" alt=""/> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-6.jpg" alt=""/> </a>
                                                            </div>                                                       
                                            ...
                                            <div class="thumbnail-wrap">
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-12.jpg" alt=""/> </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-7.jpg" alt=""/>  </a>
                                                            </div>                                                   
                                                ...
                                                <div class="thumbnail">
                                                    <div class="thumbnail-img light-bg">
                                                        <div class="flipper">
                                                            <div class="front">
                                                                <a href="#">
                                                                    <img class="img-responsive" src="assets/img/main/product/prod-13.jpg" alt=""/>                                                      
                                                                </a>
                                                            </div>
                                                            <div class="back">                                                               
                                                                <a href="#">
                                                ...
                                                <div class="thumbnail">
                                                    <div class="col-md-4 col-sm-12">    
                                                        <div class="thumbnail-img light-bg">
                                                            <div class="flipper">
                                                                <div class="front">
                                                                    <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-2.jpg" alt=""/> </a>
                                                                </div>
                                                                <div class="back">                                                               
                                                                    <a href="#"> <img class="img-responsive" src="assets/img/main/product/prod-6.jpg" alt=""/> </a>
                                                                </div>                                                       
                                                                ...
                                                                <form class="product-form">                                      
                                                                    <div class="form-group selectpicker-wrapper col-sm-4">                                                                        
                                                                        <div class="search-selectpicker selectpicker-wrapper">
                                                                            <select
                                                                                class="selectpicker input-price" data-width="100%"
                                                                                data-toggle="tooltip" title="Select Color ">
                                                                                <option>Pink</option>
                                                                                <option>Blue</option>
                                                                    ...
                                                                    <div class="form-group selectpicker-wrapper col-sm-4">                                                                      
                                                                        <select
                                                                            class="selectpicker input-price" data-width="100%"
                                                                            data-toggle="tooltip" title="Select Size">
                                                                            <option>L</option>
                                                                            <option>XL</option>
                                                                            <option>M</option>
                                                                        </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="col-md-6">                                  
                        ...
                        <div class="owl-carousel prod-slider sync1">
                            <div class="item"> 
                                <img src="assets/img/main/popup/prod-1.jpg" alt="">
                                <a href="assets/img/main/popup/prod-1.jpg" data-gal="prettyPhoto[gallery2]" title="Product" class="caption-link"><i class="fa fa-arrows-alt"></i></a>
                            </div>
                            <div class="item"> 
                                <img src="assets/img/main/popup/prod-2.jpg" alt="">
                                <a href="assets/img/main/popup/prod-1.jpg" data-gal="prettyPhoto[gallery2]" title="Product" class="caption-link"><i class="fa fa-arrows-alt"></i></a>
                            </div>
                            <div class="item"> 
                                <img src="assets/img/main/popup/prod-3.jpg" alt="">
                                <a href="assets/img/main/popup/prod-3.jpg" data-gal="prettyPhoto[gallery2]" title="Product" class="caption-link"><i class="fa fa-arrows-alt"></i></a>
                            </div>
                            <div class="item"> 
                                <img src="assets/img/main/popup/prod-4.jpg" alt="">
                                <a href="assets/img/main/popup/prod-4.jpg" data-gal="prettyPhoto[gallery2]" title="Product" class="caption-link"><i class="fa fa-arrows-alt"></i></a>
                            </div>
                        </div>

                        <div  class="owl-carousel sync2">
                            <div class="item"> <img src="assets/img/main/popup/prod-thumb-1.jpg" alt=""> </div>
                            <div class="item"> <img src="assets/img/main/popup/prod-thumb-2.jpg" alt=""> </div>
                            <div class="item"> <img src="assets/img/main/popup/prod-thumb-3.jpg" alt=""> </div>
                            <div class="item"> <img src="assets/img/main/popup/prod-thumb-4.jpg" alt=""> </div>
                        </div>
                        <!-- / Main Slider Ends -->                                      
                    </div>
   ...
   <?php include("../layouts/footer_2.php"); ?>
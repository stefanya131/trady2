  ...
  <head>
    ...
    <link href="login/login.html" rel="text/html">
  </head>
  <body>
  <div class="body-wrapper" style="position: static;">
      <header class="header transparent no-shadow">
        <div class="logo">
          <a href="/copia de trady 2" class="logo-color-bg">
            <img alt="" src="assets/images/top-bar/Header1.png" style="width:90px;" />
          </a>
        </div>
        <div class="user-buttons">
          <a href="login/login.html" class="user-login"></a>
          <a href="#" class="add-listing">¡Barter!
         <img  alt="" src="assets/images/top-bar/Header2.png" style="width: 60px;">
          
          </a>
        </div>
        <div class="navbar navbar-inverse transparent" role="navigation" id="slide-nav">
          <div class="container">
            <div id="slidemenu">
              <ul class="nav navbar-nav navbar-right">
                <li class="dropdown ">
                  <a href="#" class="dropdown-toggle " data-toggle="dropdown">Stuff bartering<b class="caret"></b></a>
               ...
               <img  alt="" src="assets/images/top-bar/home.png" style="width: 30px;">  
               </a></li>
              <li>  
               <a href="#" style="display: inline-block;">
               <img  alt="" src="assets/images/top-bar/campana1_hover.png" style="width: 26px;">  
               </a></li>

                <li> 
               <a href="#" style="display: inline-block;">
               <img  alt="" src="assets/images/top-bar/corazon.png" style="width: 35px;">  
               </a></li>

                <li> 
               <a href="#" style="display: inline-block;">
               <img  alt="" src="assets/images/top-bar/ayuda.png" style="width: 19px;">  
               </a></li>
                </li>
               </ul>
            </div>
